function [N b] = computeNormalsSquareSupport(pcl, missingMask, R, sc, superpixels)
...
% Modified this for my own use
  X = reshape(pcl(:,1),[480,640]);
  Y = reshape(pcl(:,2),[480,640]);
  Z = reshape(pcl(:,3),[480,640]);
